...
<div class = 'child main'>
  ...
  {% if postsCovered < postCount %}
    <button class="loadMore flex"><span class = 'mobile'>LOAD MORE WICKED NEWS</span><span class = 'desktop'>SHOW ME MORE WICKED NEWS</span><span><i class="fa fa-arrow-down" aria-hidden="true"></i></span></button>
  {% endif %}
  </div>